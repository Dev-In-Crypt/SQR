export const UI_ERROR_MESSAGES: Record<string, string> = {
  ...
  BLOCKSCOUT_RATE_LIMIT: "Explorer rate limit reached. Please retry shortly.",
  BLOCKSCOUT_TIMEOUT: "Explorer timeout. Please retry.",
  BLOCKSCOUT_HTTP_429: "Explorer rate limit reached. Please retry shortly.",
  BLOCKSCOUT_HTTP_503: "Explorer is temporarily unavailable. Please retry.",
